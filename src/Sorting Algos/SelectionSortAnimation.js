...
export function animateSelectionSort(array, speed, storeTimeoutId, sortingInProgress) {
    ...
    const animations = getSelectionSortAnimations(auxiliaryArray);
    ...
    for (let i = 0; i < animations.length; i++) {
        ...
        if (!isSwap) {
            const color = i % 4 === 0 ? 'red' : 'turquoise'; // Change color every two comparisons
